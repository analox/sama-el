 ...
 *      $RCSfile: NoisyIOSamples.cpp,v $<BR>
 *
 *  \par Changes:
 *      $Log: NoisyIOSamples.cpp,v $
...
#include "TestData/TimeSeries/NoisyIOSamples.h"
				    ...
				    Array< double >& outvar )
{
	...
	estInVar  += ( sqr( in  - inMean  ) - estInVar  ) / double( winSize );
	estOutVar += ( sqr( out - outMean ) - estOutVar ) / double( winSize );
    }
