 ...
 *      $RCSfile: ArrayTable.h,v $<BR>
 *      $Revision: 2.2 $<BR>
 *      $Date: 2004/11/16 13:30:10 $
 *
 *  \par Changes:
 *      $Log: ArrayTable.h,v $
 *      Revision 2.2  2004/11/16 13:30:10  glasmtbl
 *      Tobias Glasmachers, 2004/11/16, minor change:
 *      Copy constructor for ArrayTable<T> added.
 *      This avoids some strange buggy behavoir.
 *
 ...
 *      INI Administration
 *
 *      Revision 1.3  2002/05/16 13:18:35  rudi
 *      doxygen commands added/modified.
 *
 *      Revision 1.2  2002/02/06 14:26:10  rudi
 *      Some doxgen comments added.
 *
 *
 ...
 *
 */ 
  T& operator ()(unsigned i,unsigned j){ return P1(i)[j]; }
 ...
 *
 */ 
  T& operator ()(unsigned i,unsigned j,unsigned k){ return P2(i)[j][k]; }
