...
class Normal : public RandomVar< double >
{
  public:
    ...
    *
    */
    void seed( long s ) { RandomVar< double >::seed( s ); iset = false; }
    ...
    *
    */
    double variance( ) const            { return pStdDev * pStdDev; }
    ...
    *
    */
    void   mean    ( double newMean )   { pMean = newMean;          }
    ...
    *
    */
    void   variance( double newVar )    { pStdDev = sqrt( newVar ); }
