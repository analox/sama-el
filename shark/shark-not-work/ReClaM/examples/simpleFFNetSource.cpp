 ...
 *      $RCSfile: simpleFFNetSource.cpp,v $<BR>
 *      $Revision: 2.2 $<BR>
 *      $Date: 2004/06/09 16:34:41 $
 *
 *  \par Changes:
 *      $Log: simpleFFNetSource.cpp,v $
 *      Revision 2.2  2004/06/09 16:34:41  saviapbe
 *
 *      Adapted for MS VC++ v6 and MS VC++ v7.
 *
 *      Revision 2.1  2004/05/27 15:07:47  saviapbe
 *
 *      Examples for FFNetSource and MSERNNet were added.
 *
 *
 *
...
class Net : public MSEFFNet, // feed-forward network
	    public IRpropMinus           // resilent backpropagation
{
 public:
  Net      (const string &filename, double c = 0) : MSEFFNet(filename) { initRprop(); }
