 ...
 *      $RCSfile: ArraySort.h,v $<BR>
 *      $Revision: 2.2 $<BR>
 *      $Date: 2005/01/31 11:13:09 $
 *
 *  \par Changes:
 *      $Log: ArraySort.h,v $
 *      Revision 2.2  2005/01/31 11:13:09  shark-admin
 *      random -> myrandom
 *
 *      Revision 2.1  2005/01/25 17:21:18  shark-admin
 *      sort2Dby1st() added
 *
 ...
 *      INI Administration
 *
 *      Revision 1.2  2002/05/16 13:18:35  rudi
...
void sort2DBy1st( Array< double >& value )
{
    const unsigned StackSize = 100;
    unsigned Lstack[ StackSize ];
    unsigned Rstack[ StackSize ];
