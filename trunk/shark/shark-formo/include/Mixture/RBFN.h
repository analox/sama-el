...
class RBFN : public MixtureOfGaussians
{
  public:
    ...
    double& weight( unsigned i, unsigned j )       { return A( i, j ); }
    double& bias  ( unsigned i )                   { return b( i );    }
    double  weight( unsigned i, unsigned j ) const { return A( i, j ); }
    double  bias  ( unsigned i ) const             { return b( i );    }

    const Array< double >& weight( ) const         { return A;         }
    const Array< double >& bias  ( ) const         { return b;         }
