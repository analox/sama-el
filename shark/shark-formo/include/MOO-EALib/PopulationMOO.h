 ...
 *      $RCSfile: PopulationMOO.h,v $<BR>
 *
 *  \par Changes:
 *      $Log: PopulationMOO.h,v $
 *      Revision 2.17  2006/04/30 16:56:55  christian_igel
 *      simplified
 *
 *      Revision 2.16  2006/04/18 10:26:03  glasmtbl
 *      TG 4/2006: gcc 4.1.0 compatibility ensured
 *
 *      Revision 2.13  2005/06/21 09:52:03  christian_igel
 *      SMeasure added
 *
 *      Revision 2.12  2005/06/10 13:02:57  glasmtbl
 *      *** empty log message ***
 *
 *      Revision 2.11  2005/01/14 15:02:12  shark-admin
 *      crowdingDistance() -> crowdingDistance(unpenalized=false)
 *
 *      Revision 2.10  2004/12/30 13:09:27  shark-admin
 *      selectBinaryTounamentMOO(...)changed to selectBinaryTournamentMOO(...)
 *
 *      Revision 2.9  2004/12/27 16:05:30  shark-admin
 *      selectUniformRanking(...) and reproduce(...) un-overloaded (inheritance by EALib/Population)
 *
 *      Revision 2.8  2004/12/10 18:37:05  christian_igel
 *      New selection mechanisms added.
 *
 *      Revision 2.7  2004/11/15 15:36:19  shark-admin
 *      compatibility with vc++ ensured
 *
 *      Revision 2.6  2004/05/20 12:06:50  shark-admin
 *      documentation modified
 *
 *      Revision 2.5  2004/04/27 14:48:38  shark-admin
 *      void nichedComparisonRank(...) with changed return type 'void'
 *
 *      Revision 2.4  2004/04/12 15:11:25  shark-admin
 *      new selection-method added: 'selectCrowdedEPTournament(...)'
 *      method added that returns ranking according  NSGA2-niched-comparison operator: 'nichedComparisonRank(...)'
 *
...
#ifndef __POPULATIONMOO_H
#define __POPULATIONMOO_H
...
class PopulationMOO : public Population
{
 public:
  ...
  // ---------------------------------------------------  
  // TO-PM-210
  int Dominate( unsigned, unsigned );
  // TO-PM-211
...
// used for sorting in PopulationMOO::crowdedDistance
class SortMOO_CD
{
public:
...
// used for sorting in PopulationMOO::nichedComparisonRank
class SortMOO_NCR
{
public:
