 ...
 *      $RCSfile: eigensymmJacobi_test.cpp,v $<BR>
 *
 *  \par Changes:
 *      $Log: eigensymmJacobi_test.cpp,v $
...
int main() 
{
    ...
    eigensymmJacobi(A, x, lambda);

    // Output of results:
    cout << "matrixof eigenvectors:" << endl;
    writeArray(x, cout);
