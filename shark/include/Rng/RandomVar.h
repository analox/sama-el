 ...
 *      INI Administration
 *
 *      Revision 1.4  2002/07/17 14:36:24  kreutz
 *      missing virtual destructors added
 *
 *      Revision 1.3  2002/07/11 09:06:51  kreutz
...
class RandomVar
{
  public:
    ...
    *
    */
    virtual void   seed( long s ) { rng.seed( s ); }
    ...
    *
    */
    RandomVar& operator = ( const RandomVar& r ) { rng = r.rng; return *this; }
