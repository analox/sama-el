 ...
 *      $RCSfile: FileUtil.h,v $<BR>
 *      $Revision: 2.3 $<BR>
 *      $Date: 2006/04/30 21:08:13 $
 *
 *  \par Changes:
 *      $Log: FileUtil.h,v $
 *      Revision 2.3  2006/04/30 21:08:13  christian_igel
 *      simplified scanLine_strict
 *
 *      Revision 2.2  2004/11/15 16:18:24  shark-admin
 *      std namespace membership assigned to io operators
 *
 ...
 *      INI Administration
 *
 *      Revision 1.4  2002/02/06 14:44:31  rudi
 *      Doxygen comments added, some methods renamed.
 *
 *
 *
 ...
 *
 */  
enum iotype { SetDefault, ScanFrom, PrintTo };
