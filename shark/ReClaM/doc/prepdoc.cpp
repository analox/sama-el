...
// Name of the package:
const string  package_name   = "ReClaM";
...
const unsigned no_placeholders = 47;
...
string placeholder_list[ no_placeholders * 4 ] = {
    ...
    "AdpBP90a", "ADAP1", "annotated.html", "",
    "AdpBP90b", "ADAP2", "annotated.html", "",
    "CE", "CLASSE", "annotated.html", "",
    "CG", "CG", "annotated.html", "",
    "CrossEntropy", "CROSSENT", "annotated.html", "",
    "EarlyStopping", "EARLYSTOP", "annotated.html", "",
    "ErrorMeasures", "ERRORMEAS", "annotated.html", "",
    "FFNet", "FF", "annotated.html", "",
    "FFNet.h", "BFF", "globals.html", "",
    "IRpropMinus", "IRPROPM", "annotated.html", "",
    "IRpropPlus", "IRPROPP", "annotated.html", "",
    "LinearOutputTanhNet", "LINOUTTANH", "annotated.html", "",
    "LinOutFFNet", "LINOUTFF", "annotated.html", "",
    "LinOutMSEBFFNet", "LINOUTMSEBFF", "annotated.html", "",
    "LinOutMSEFFNet", "LINOUTMSEFF", "annotated.html", "",
    "MeanSquaredError", "MSQRE", "annotated.html", "",
    "ModelInterface", "MODELINT", "annotated.html", "",
    "MSEFFNet", "MSEFF", "annotated.html", "",
    "MSEFFNet.h", "MSEBFF", "globals.html", "",
    "MSERBFNet", "MSERBF", "annotated.html", "",
    "MSERNNet", "MSERN", "annotated.html", "",
    "NetParams", "NETPARAMS", "annotated.html", "",
    "Params", "PARAMS", "annotated.html", "",
    "ProbenBNet", "PROBENB", "annotated.html", "",
    "ProbenNet", "PROBEN", "annotated.html", "",
    "Quickprop", "QPROP", "annotated.html", "",
    "RBFNet", "RBF", "annotated.html", "",
    "RpropMinus", "RPROPM", "annotated.html", "",
    "RpropPlus", "RPROPP", "annotated.html", "",
    "SquaredError", "SQRE", "annotated.html", "",
    "SteepestDescent", "STEEPDESC", "annotated.html", "",
    "StochasticGradientDescent", "STOCHGRADDESC", "annotated.html", "",
    "TanhNet", "TANH", "annotated.html", "",
    "VarianceEstimator", "VAREST", "annotated.html", "",
    "simpleFFNet.cpp", "EXFF", "examples.html", "",
    "simpleRBFNet.cpp", "EXRBF", "examples.html", "",
    "simpleRNNet.cpp", "EXRN", "examples.html", "",
    "FileUtil", "FILEUTIL", "namespaces.html", "",
    "IOTools.h", "IOTOOLS", "files.html", "",
    "errorPercentage", "EMEP", "$ErrorMeasures", "", 
    "meanSquaredError", "EMMSQR", "$ErrorMeasures", "", 
    "squaredError", "EMSQR", "$ErrorMeasures", "", 
    "variance", "EMVAR", "$ErrorMeasures", "",
    "wta", "EMWTA", "$ErrorMeasures", "",
    "crossEntropy", "EMCROSSENT", "$ErrorMeasures", "",
    "binaryCriterion", "EMBC", "$ErrorMeasures", "",
    "createConnectionMatrix.h", "CREATECONNECT", "files.html", ""
};
