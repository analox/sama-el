 ...
 *      $RCSfile: FFNet.h,v $<BR>
 *      $Revision: 2.4 $<BR>
 *      $Date: 2005/05/23 19:11:12 $
 *
 *  \par Changes:
 *      $Log: FFNet.h,v $
 *      Revision 2.4  2005/05/23 19:11:12  christian_igel
 *      moved activate implementation into header file
 *      now it works with g++4 .. strange
 *
 *      Revision 2.3  2004/06/16 15:22:20  saviapbe
 *
 *      Some bugs in the doxygen documentation were removed.
 *
 *      Revision 2.2  2004/05/05 13:29:43  saviapbe
 *      The CVS logging was corrected.
 *
 *      Revision 2.1  2004/05/03 15:33:27  christian_igel
 *      Added delta to copy constructor.
 *
 ...
 *      stable
 */
class FFNet :  virtual public ModelInterface {
...
public:
  ...
  friend std::istream& operator>> (std::istream& is, FFNet &net);

  //! Writes the data of a network to an output stream.
  friend std::ostream& operator<< (std::ostream& os, FFNet &net);
