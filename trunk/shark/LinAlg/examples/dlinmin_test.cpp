 ...
 *      $RCSfile: dlinmin_test.cpp,v $<BR>
 *
 *  \par Changes:
 *      $Log: dlinmin_test.cpp,v $
...
int main()
{
    ...
    cout << "Performing a derived line minimization for function "
         << "f(x) = x*x + 2 "
         << "with starting point (-3, 11) and direction (3, 11):" 
         << endl << endl;

    // Minimize function:
    dlinmin(p, xi, fret, testfunc, dtestfunc);
