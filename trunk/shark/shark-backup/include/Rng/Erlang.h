 ...
 *
 */
    double mean    ( ) const            { return pMean;        }
 ...
 *
 */
    double variance( ) const            { return pVariance;    }
 ...
 *
 */
    void   mean    ( double newMean )   { pMean     = newMean; setState( ); }
 ...
 *
 */
    void   variance( double newVar )    { pVariance = newVar;  setState( ); }
  ...
  private:
    ...
    // The distribution's parameter "k" (the order of the distribution) 
    unsigned pK;

    // The distributions parameter "alpha" (the scale of the distribution)
    double   pA;
