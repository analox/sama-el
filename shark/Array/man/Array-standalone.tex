...
\author{Copyright \copyright\ 1996, 1999 Martin Kreutz, Bernhard
...
\date{\today}
\title{{\package-name}: A C++ class library for evolutionary algorithms}
\version{1.4}
\miniabstract{
{\package-name} is a
C++ library of classes designed for experimentation
with evolutionary algorithms and related techniques.
...
Therefore, the major emphasis has been put on providing as much flexibility
and extendibility as possible.
Efficiency has been considered important as well, but has been sacrificed
where it conflicts with flexibility.
This documentation gives a short overview of how evolutionary algorithms
work, the most important operators, the programming interface and the
examples illustrating the usage of the {\package-name} classes.
}
