 ...
 *      $RCSfile: VarianceEstimator.h,v $<BR>
 *      $Revision: 2.0 $<BR>
 *      $Date: 2003/11/28 16:23:22 $
 *
 *  \par Changes:
 *      $Log: VarianceEstimator.h,v $
 ...
 *      INI Administration
 *
 *      Revision 1.3  2002/05/16 13:27:41  rudi
 ...
 *      stable
 */
class VarianceEstimator : virtual public ModelInterface
{
  public:
    ...
    //=======================================================================
    /*!
     *  \brief Creates a new instance of class "Variance Estimator".
     *
     *  \author  M. Kreutz
     *  \date    2001-05-04
     *
    ...
    void estimateFisherInformation
    (
