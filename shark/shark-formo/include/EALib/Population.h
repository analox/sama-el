 ...
 *      $RCSfile: Population.h,v $<BR>
 *
 *  \par Changes:
 *      $Log: Population.h,v $
 *      Revision 2.2  2004/05/20 12:32:37  shark-admin
 *      documentation enhanced
 *
 *      Revision 2.1  2004/04/12 07:42:20  shark-admin
...
class Population : protected std::vector< Individual * >
{
  public:
    ...
    void              setMaximize           ( ) { ascending = false; }
    void              setMinimize           ( ) { ascending = true;  }

    void              spinWheelOneTime      ( ) { spinOnce  = true;  }
    void              spinWheelMultipleTimes( ) { spinOnce  = false; }

    bool              ascendingFitness      ( ) const { return ascending; }
    ...
    Individual&       best  ( )       { return ( *this )[ bestIndex( ) ]; }
    const Individual& best  ( ) const { return ( *this )[ bestIndex( ) ]; }

    Individual&       worst ( )       { return ( *this )[ worstIndex( ) ]; }
    const Individual& worst ( ) const { return ( *this )[ worstIndex( ) ]; }
    ...
    void              setSubPop( bool sub ) { subPop = sub; }

    bool              getSubPop( ) const { return subPop; }

    bool              getSpinOnce( ) const { return spinOnce; }
