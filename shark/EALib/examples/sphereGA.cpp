...
int main( int argc, char **argv )
{
    ...
    // define populations
    //
    Population parents   ( PopSize, ChromosomeT< bool >( Dimension * NumOfBits ) );
    Population offsprings( PopSize, ChromosomeT< bool >( Dimension * NumOfBits ) );
