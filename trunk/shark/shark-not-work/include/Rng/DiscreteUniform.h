 ...
 *      $RCSfile: DiscreteUniform.h,v $<BR>
 *      $Revision: 2.1 $<BR>
 *      $Date: 2006/02/02 12:01:40 $
 *
 *  \par Changes:
 *      $Log: DiscreteUniform.h,v $
