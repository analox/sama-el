...
// Name of the package:
const string  package_name   = "MOO-EALib";
...
const unsigned no_placeholders = 8;
...
string placeholder_list[ no_placeholders * 4 ] = {
  "ArchiveMOO.cpp", "01", "files.html", "",
  "IndividualMOO.cpp", "02", "files.html", "",
  "PopulationMOO.cpp", "03", "files.html", "",
  "DWA.cpp", "04", "examples.html", "",
  "NSGA2.cpp", "05", "examples.html", "",
  "PAES.cpp", "06", "examples.html", "",
  "VEGA.cpp", "07", "examples.html", "",
  "MOGA.cpp", "08", "examples.html", ""
};
