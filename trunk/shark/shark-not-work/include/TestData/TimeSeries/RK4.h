...
class RK4 : public Generator< Array< double > >
{
  public:
    RK4( unsigned dim, double stepsize );
  ...
  protected:
    double   h;
    unsigned t;
    Array< double > y, dy, dym, dyt, yt;

    virtual void derivative( const Array< double >&,
			     Array< double >& ) const = 0;
};
